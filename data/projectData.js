...
const PROJRECTS = [
...

  {
    ...
    href: 'https://connect_personal.surge.sh/',
    git: 'https://github.com/sarah27h/connect_personnel',
    info: '● Built a home page for Connect Personal as a part from freelancer Contests.',
    tech: 'Bootstrap 4.5, Responsive, Cross-browsers ',
  },
  {
    title: 'Rheumatology Capsules',
    src: 'images/project8.png',
    alt: 'Rheumatology Capsules project',
